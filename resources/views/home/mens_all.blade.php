...
@foreach($mens_product as $mens_product)
  ...
  <div class="card">
    ...
    <div class="view overlay">
      <img class="card-img-top" src="product/{{$mens_product->image}}" alt="Card image cap">
      <a href="#!">
    ...
    <div class="card-body">
      ...
      <!--Title-->
      <h4 class="card-title">{{$mens_product->title}}</h4>
      <!--Text-->
      <p class="card-text">{{$mens_product->description}}</p>
      ...
      <ul>
                                            ...
                                            <form action="{{url('add_cart',$mens_product->id)}}" method="POST">
                                                @csrf
                                            <li>
