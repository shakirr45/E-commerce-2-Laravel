...
@foreach($womens_product as $womens_product)
  ...
  <div class="card">
    ...
    <div class="view overlay">
      <img class="card-img-top" src="product/{{$womens_product->image}}" alt="Card image cap">
      <a href="#!">
    ...
    <div class="card-body">
      ...
      <!--Title-->
      <h4 class="card-title">{{$womens_product->title}}</h4>
      <!--Text-->
      <p class="card-text">{{$womens_product->description}}</p>
      ...
      <ul>
                                            ...
                                            <form action="{{url('add_cart_women',$womens_product->id)}}" method="POST">
                                                @csrf
                                            <li>
